...
import cat.itacademy.barcelonactiva.cognoms.nom.s05.t02.S05T02CaballeroJoan.Model.Security.JwtFilter;
...
public class GameControllerUnitTest {
    ...
    @BeforeEach
    void setUp(){
        gameDTO = GameDTO.builder().gameID(1).playerID(1).diceOne(3).diceTwo(4).won(true).build();
    }
    @AfterEach
    void reset(){
        gameDTO = null;
    ...
    @DisplayName("GameControllerUnitTest - deleteGames remove games")
    @Test
    ...
    @DisplayName("GameControllerUnitTest - getGames return list of games")
    @Test
    void getGames() throws Exception{
        GameDTO gameDTO1 = GameDTO.builder().gameID(2).playerID(1).diceOne(2).diceTwo(4).won(false).build();
